    ...
    return (
        <div className="bg-(--color-bg) py-20 px-10 lg:px-32 h-min-screen">
            <div className="bg-white rounded-2xl px-2 py-10">
                <h3 className="text-4xl font-extrabold text-center mb-1.5" data-testid="live-anywhere" >Live AnyWhere</h3>
                ...
                <div className="mt-12 border-1 text-center border-gray-300 rounded-3xl w-35 text-gray-500 mx-auto">
                    Load more
                </div>
            </div>
        </div>
